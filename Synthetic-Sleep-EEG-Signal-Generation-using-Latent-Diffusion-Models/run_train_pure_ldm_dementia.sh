...
#SBATCH --job-name=batced_ldm_caueeg2_mci
#SBATCH --output=outputs/batced_ldm_caueeg2_mci.out
...
echo "Run ID: ${TIMESTAMP}, training LDM on CAUEEG2 dataset"
...
python src/train_pure_ldm.py \
    ...
    --batch_size 4 \
    --config_file /home/stud/timlin/bhome/DiffusionEEG/Synthetic-Sleep-EEG-Signal-Generation-using-Latent-Diffusion-Models/project/config/config_dm_dementia.yaml \
    --spe spectral
