...
#SBATCH --output=outputs/ldm_caueeg_mci.out
...
python src/train_ldm.py \
    ...
    --latent_channels 4 \
    --best_model_path "/home/stud/timlin/bhome/DiffusionEEG/Synthetic-Sleep-EEG-Signal-Generation-using-Latent-Diffusion-Models/project/outputs/aekl_eeg_stable_label_mci" \
