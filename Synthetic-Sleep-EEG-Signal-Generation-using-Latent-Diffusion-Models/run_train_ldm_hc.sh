...
#SBATCH --output=outputs/ldm_caueeg2_hc.out
...
python src/train_ldm.py \
    ...
    --latent_channels 8 \
    --best_model_path "/home/stud/timlin/bhome/DiffusionEEG/Synthetic-Sleep-EEG-Signal-Generation-using-Latent-Diffusion-Models/project/outputs/aekl_eeg_caueeg2_label_hc" \
