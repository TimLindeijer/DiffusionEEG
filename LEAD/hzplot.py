...
psd_fig.savefig(os.path.join(output_dir, 'ldm_eeg_psd_all_channels_feature02_1000TP.png'))
...
plt.savefig(os.path.join(output_dir, 'ldm_eeg_raw_sample_feat02_1000TP.png'))
