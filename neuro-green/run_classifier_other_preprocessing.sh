...
mkdir -p outputs
mkdir -p results/caueeg2_classification_other_preprocessing
...
OUTPUT_DIR="results/caueeg2_classification_other_preprocessing"
DERIVATIVES_SUBDIR="derivatives/preprocessed"  # Relative to DATA_DIR
...
python neuro-green/caueeg_green_classifier_other_loader.py \
    --data_dir "$DATA_DIR" \
