...
#SBATCH --job-name=augmented-40
#SBATCH --output=outputs/augmented_40_%j.out
...
# Set paths
DATA_DIR="/home/stud/timlin/bhome/DiffusionEEG/dataset/ftsurrogate_ready_datasets/train_augmented_40pct"
TEST_DATA_DIR="/home/stud/timlin/bhome/DiffusionEEG/dataset/ftsurrogate_ready_datasets/test_genuine"
OUTPUT_DIR="results/augmented_40_classification"
RUN_NAME="AUGMENTED_40_$(date +%Y%m%d_%H%M%S)"
...
python neuro-green/train_green_model.py \
    ...
    --wandb_name "$RUN_NAME" \
    --wandb_tags "caueeg2" "genuine" "augmented" "40pct"
