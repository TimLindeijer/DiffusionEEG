...
#SBATCH --job-name=mlr-20
#SBATCH --output=outputs/mlr_20_%j.out
...
# Set paths
DATA_DIR="/home/stud/timlin/bhome/DiffusionEEG/dataset/ldm_norm_fix_ready_datasets/train_augmented_20pct"
TEST_DATA_DIR="/home/stud/timlin/bhome/DiffusionEEG/dataset/ldm_norm_fix_ready_datasets/test_genuine"
OUTPUT_DIR="results/ldm_mixed_classification_20"
RUN_NAME="LDM_20_NORMALIZE_FIX_$(date +%Y%m%d_%H%M%S)"
...
python neuro-green/train_green_model.py \
    ...
    --wandb_name "$RUN_NAME" \
    --wandb_tags "caueeg2" "genuine" "mixed" "classification" "ldm" "20pct"	
