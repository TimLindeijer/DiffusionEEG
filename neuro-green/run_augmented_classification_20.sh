...
#SBATCH --job-name=augmented-20
#SBATCH --output=outputs/augmented_20_%j.out
...
# Set paths
DATA_DIR="/home/stud/timlin/bhome/DiffusionEEG/dataset/ftsurrogate_ready_datasets/train_augmented_20pct"
TEST_DATA_DIR="/home/stud/timlin/bhome/DiffusionEEG/dataset/ftsurrogate_ready_datasets/test_genuine"
OUTPUT_DIR="results/augmented_20_classification"
RUN_NAME="AUGMENTED_20_$(date +%Y%m%d_%H%M%S)"
...
python neuro-green/train_green_model.py \
    ...
    --wandb_name "$RUN_NAME" \
    --wandb_tags "caueeg2" "genuine" "augmented" "20pct"
