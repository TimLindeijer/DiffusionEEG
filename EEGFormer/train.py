...
# ========== REPLACEMENT FOR CSV DATA ==========
# Generate dummy data with same dimensions as original CSV
num_samples = 11500  # Matching original data size
num_features = 177   # Columns 1-178 becomes 177 features

# Random data with same shape as original esrinput
esrinput = torch.randn(num_samples, num_features, dtype=torch.float32)
# Binary labels (0/1) with same shape as esrlabel
esrlabel = torch.randint(0, 2, (num_samples,), dtype=torch.float32)
# ========== END DUMMY DATA ==========
